...
def classify_tone(paragraph, author_statement, client):
 ...
 "1. Supportive: The paragraph affirms or supports the presence of an effect, relationship, or influence towards the statement.\n"
 "2. Neutral: The paragraph does not take a stance towards the statement or indicates no effect towards the statement.\n"
 "3. Opposing: The paragraph indicates contradictory evidence with regard to the statement.\n\n"
